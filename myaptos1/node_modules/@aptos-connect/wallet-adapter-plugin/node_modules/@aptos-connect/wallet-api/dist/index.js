...
function decodePopupWalletRequest(encoded) {
  ...
  return JSON.parse(serialized, (key, value) => {
    switch (key) {
      ...
      case "clientIdentityKey":
        return new import_ts_sdk16.Ed25519PublicKey(base64ToBytes(value));
      case "signature":
        return new import_ts_sdk16.Ed25519Signature(base64ToBytes(value));
      default:
        return value;
    }
  });
...
function makePopupWalletRequestChallenge({
  ...
  if (accountAddress !== void 0) {
    serializer.serialize(import_ts_sdk16.AccountAddress.from(accountAddress));
  }
